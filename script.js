...
var userNameInputEl = document.getElementById("initials-input");
...
var userName = ""; //stores the user Name
var numberCorrect = 0; // stores the number of correct answers
var numberIncorrect = 0; // stores the number of incorrect answers
var scoresArray = []; // stores the user username and score to the localStorage
var scoresArrayObj = []; // stores the user username and score to the localStorage
...
function saveScore(event) {
  ...
  scoreAndInitialsObj.name = userName;
...
// Function to shuffle the random questions array 
...
//calls the Function and Event listeners
